        ...
        body: Consumer<MainProvider>(
          builder: (context, valueMain, child) => NativeDataTable.builder(
            ...
            itemBuilder: (index) => DataRow(cells: [
              DataCell(Text(valueMain.orderResvDevicesList[index].deviceName)),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(DateFormat.yMd().format(DateTime.parse(
                          valueMain.orderResvDevicesList[index].startDate))),
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('To:'),
                      Text(DateFormat.yMd().format(DateTime.parse(
                          valueMain.orderResvDevicesList[index].endDate))),
                    ],
                  ),
                ],
              )),
                ...
                Consumer<AuthProvider>(
                  builder: (context, valueAuth, child) => Row(
                    children: [
                      Text(valueAuth
                          .findEmployeeById(
                              valueMain.orderResvDevicesList[index].userId)
                          .name),
                      SizedBox(
                        width: 5,
                      ),
